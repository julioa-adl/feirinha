...
const NotFindListCart = () => {
  return (
    <>
      ...
      <h1 className='text-yellow-500 text-xl text-center font-thin'>Vamos iniciar sua lista?</h1>
      <p className='text-yellow-500 text-lg text-center'>Toque no botão + para adicionar produtos</p>
    </>
  )
}
