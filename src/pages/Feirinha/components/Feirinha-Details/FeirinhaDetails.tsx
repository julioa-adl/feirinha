...
const FeirinhaDetails = () => {
  ...
  return (
    <div className="bg-white h-screen overflow-hidden dark:bg-gray-900">
      ...
      <ul className='w-screem h-full pb-52 lg:h-4/5 px-5 overflow-y-auto flex flex-col items-center gap-1 drop-shadow-lg'>
        { !(feirinhaLoading && marketLoading) ? (
